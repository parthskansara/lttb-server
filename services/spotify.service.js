...
export const createPlaylist = async (followerUserId, followerAccessToken, playlistName, playlistDescription) => {
...
export const addSongToPlaylist = async (followerAccessToken, playlistId, trackPosition, songUri) => {
